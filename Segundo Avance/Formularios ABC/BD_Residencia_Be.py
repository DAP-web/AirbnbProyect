...
def insertResidencias(
    tipo, rooms, bathrooms, beds, direction, price, cancellation, plus, pets, smokers
):
    try:
        with connection.cursor() as cursor:
...
def updateResidenciaBD(
    ...
    try:
        with connection.cursor() as cursor:
            ...
            TipoAlojamiento = '{tipo}', Habitaciones = {rooms}, Banhos = {bathrooms}, Camas = {beds}, Precio = {price}, FlexibilidadDeCancelacion = {cancellation}, AirbnbPlus = {plus}, Mascotas = {pets}, Fumadores = {smokers}
