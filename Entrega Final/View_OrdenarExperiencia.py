...
from Logic_OrganizarExperienciaLogic import OrganizarExperienciaLogic


class OrganizarexperienciasBE:
    def __init__(self):
        self.dborganizarexperiencia = OrganizarExperienciaLogic()
    def getAllOrganizarExperiencias(self):
            result = self.dborganizarexperiencia.getOrganizarExperiencia()
    ...
    def addOrganizarExperiencia(self):
        ...
        print(dborganizarexperiencia.printOrganizarExperiencia())
    ...
    def updateOrganizarExperiencias(self):
