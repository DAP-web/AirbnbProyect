...
INSERT INTO `calificaciones` VALUES (1,5,9),(2,5,10),(3,4,11),(4,2,9),(5,4,10),(6,4,12);
...
INSERT INTO `ciudades` VALUES (1,'Missouri',2),(2,'Hamburg',1),(3,'San Salvador',3),(4,'La Libertad',3),(6,'Brasilia',9),(8,'Montevideo',14);
...
INSERT INTO `clientes` VALUES (1,'Diego','Portillo','63212542','Alemania','d@p.com','lossuperheroes','superportillo'),(2,'Tammy','Portillo','62514452','Estados Unidos','t@p.com','guafguaf','tporguaf'),(3,'Angela','Ruiz','62354126','Italia','a@r.com','lasheroinas','gossi'),(7,'Aaron','Ramos','15462354','Venezuela','aaron@aaron.aaron','aaron','Ejau'),(8,'James','March','54125262','Estados Unidos','j@m.com','hotel','jpatrickM'),(9,'Sheldon','Cooper','61542635','Estados Unidos','sheldon@cal.com','physics','scooper'),(12,'Victoria','Zepeda','56632248','Cuba','v@az.com','villacincos','azepeda'),(14,'Gaby','Beltran','12524263','El Salvador','g@b.com','password','gbeltran'),(15,'Giovanni','Portillo','52633541','Ecuador','g@gp.com','warzone','gplikol');
...
INSERT INTO `direcciones` VALUES (1,'Missouri','6542','Brave Street',2),(2,'Colonia','1623','6th Kirk Street',1),(3,'La Libertad','6251','San Ignacio',3),(4,'California','1632','Main Street',1),(6,'Las Bahamas','6241','Elm',1),(9,'Pasadena','6323','Los coballos',8);
...
INSERT INTO `experiencia` VALUES (1,'Diego','Un viaje a las estreallas',1,'Los Angeles','Blow your mind','Aleman','Jovenes de alreededor de 20 anhos','Ninguna','Alta','Disposicion',1,18.00,1),(2,'Alejandro','Aventuras',0,'New Jersey','Blowing','Ingles','Jovenes','Sae','Media','Lapiz y hoja de papel',0,25.00,2),(3,'Jesse','LATAM',0,'Chile','Atentos','Espanhol','Todos','JJ','Alta','Oidos y disposicion',1,13.00,3);
...
INSERT INTO `factura` VALUES (1,9,1,1,NULL,13,288.15,0),(2,10,2,2,NULL,13,250.65,1),(3,11,3,3,NULL,13,200.00,0),(4,NULL,NULL,2,2,0,250.31,1);
...
INSERT INTO `paises` VALUES (1,'Alemania','+49'),(2,'Estados Unidos','+1'),(3,'El Salvador','+503'),(4,'Costa Rica','+506'),(5,'Panamá','+507'),(6,'Nicaragua','+505'),(7,'Cuba','+53'),(8,'Argentina','+54'),(9,'Brasil','+55'),(10,'Canada','+1'),(11,'Guatemala','+502'),(12,'Mexico','+52'),(13,'Puerto Rico','+1'),(14,'Uruguay','+598'),(15,'Suiza','+41'),(16,'Austria','+43'),(17,'Francia','+33'),(18,'Espanha','+34'),(19,'Finlandia','+358'),(20,'Grecia','+30'),(21,'Holanda','+31'),(22,'Italia','+39'),(24,'Chile','+56');
...
INSERT INTO `reservaciones` VALUES (1,1,9,'05-06-2012 04:00:00','05-10-2012 04:00:00',2,0,0,0),(2,2,10,'05-06-2012 04:00:00','05-10-2012 04:00:00',1,2,3,0),(3,3,11,'05-10-2012 04:00:00','05-12-2012 04:00:00',1,0,0,0),(4,8,10,'24-11-2020 15:00:00','15-12-2020 12:00:00',1,0,0,1),(5,9,10,'16-10-2021 9:00:00','02-11-2021 12:00:00',4,0,3,0),(8,7,11,'16-01-2021 18:00','20-01-2021 17:30',4,1,0,0),(9,1,11,'15-11-2020 15:00:00','1-1-2021 9:00:00',1,0,0,0),(10,1,11,'12-12-2020 11:00','3-1-2021 14:30',2,0,0,1),(13,3,12,'13-12-2020 13:00','11-1-2021 11:00',2,0,2,0),(14,1,10,'6-12-2020 12:00','25-12-2020 6:00',1,0,1,1),(17,14,13,'13-12-2020 13:00','15-1-2021 7:00',2,0,0,0);
...
INSERT INTO `residencias` VALUES (9,'Entera',3,3,3,1,200.00,0,0,0,0),(10,'Hotel',5,4,6,2,200.00,0,1,1,0),(11,'Compartida',1,1,2,1,300.00,1,0,1,1),(12,'Motel',1,1,2,3,260.32,1,1,1,0),(13,'Habitacion',1,1,2,2,15.00,1,0,0,0),(15,'Habitaciones',3,4,3,9,360.00,1,1,1,0);
...
--
-- Temporary view structure for view `rservicio`
--

DROP TABLE IF EXISTS `rservicio`;
/*!50001 DROP VIEW IF EXISTS `rservicio`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `rservicio` AS SELECT 
 1 AS `IdResidencia`,
 1 AS `NombreServicio`*/;
SET character_set_client = @saved_cs_client;
...
INSERT INTO `servicios` VALUES (1,'Cocina'),(2,'Calefaccion'),(3,'Champu'),(5,'Desayuno a la cama'),(6,'Almuerzo de la Casa'),(8,'Carro Incluido');
...
INSERT INTO `tematica` VALUES (1,'Bebida','B'),(2,'Deportes acuaticos','DA'),(3,'Deportes en combate ','Sangre,sudor y gloria'),(6,'Hawai','Sol, playa y arena');
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `facturaexperiencias` AS select `factura`.`idFactura` AS `idFactura`,`factura`.`IdExp` AS `IdExp`,`experiencia`.`PrecioIndividual` AS `PrecioIndividual`,concat(`clientes`.`Nombre`,' ',`clientes`.`Apellido`) AS `Cliente`,`clientes`.`NumeroTelefonico` AS `NumeroTelefonico`,`factura`.`IVA` AS `IVA`,`factura`.`Subtotal` AS `Subtotal`,`factura`.`Cupon` AS `Cupon` from ((`clientes` join `factura` on((`clientes`.`idClientes` = `factura`.`IdCliente`))) join `experiencia` on((`factura`.`IdExp` = `experiencia`.`idExp`))) where (`factura`.`IdResidencia` is null) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
--
-- Final view structure for view `rservicio`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `rservicio` AS select `residenciaservicio`.`IdResidencia` AS `IdResidencia`,`servicios`.`NombreServicio` AS `NombreServicio` from (`residenciaservicio` join `servicios` on((`residenciaservicio`.`IdServicio` = `servicios`.`idServicio`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2020-12-03 20:41:21
